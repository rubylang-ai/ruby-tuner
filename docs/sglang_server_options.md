...
Server Arguments[#](https://docs.sglang.ai/backend/server_arguments.html#server-arguments "Link to this heading")
-----------------------------------------------------------------------------------------------------------------

Common launch commands[#](https://docs.sglang.ai/backend/server_arguments.html#common-launch-commands "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------------

*   To enable multi-GPU tensor parallelism, add `--tp 2`. If it reports the error “peer access is not supported between these two devices”, add `--enable-p2p-check` to the server launch command.
    

python \-m sglang.launch\_server \--model\-path meta\-llama/Meta\-Llama\-3\-8B\-Instruct \--tp 2
...
python \-m sglang\_router.launch\_server \--model\-path meta\-llama/Meta\-Llama\-3\-8B\-Instruct \--dp 2 \--tp 2

*   If you see out-of-memory errors during serving, try to reduce the memory usage of the KV cache pool by setting a smaller value of `--mem-fraction-static`. The default value is `0.9`.
    

python \-m sglang.launch\_server \--model\-path meta\-llama/Meta\-Llama\-3\-8B\-Instruct \--mem\-fraction\-static 0.7

*   See [hyperparameter tuning](https://docs.sglang.ai/references/hyperparameter_tuning.html) on tuning hyperparameters for better performance.
    
*   If you see out-of-memory errors during prefill for long prompts, try to set a smaller chunked prefill size.
    

python \-m sglang.launch\_server \--model\-path meta\-llama/Meta\-Llama\-3\-8B\-Instruct \--chunked\-prefill\-size 4096
...
*   If the model does not have a chat template in the Hugging Face tokenizer, you can specify a [custom chat template](https://docs.sglang.ai/references/custom_chat_template.html).
    
*   To run tensor parallelism on multiple nodes, add `--nnodes 2`. If you have two nodes with two GPUs on each node and want to run TP=4, let `sgl-dev-0` be the hostname of the first node and `50000` be an available port, you can use the following commands. If you meet deadlock, please try to add `--disable-cuda-graph`
    

\# Node 0
python \-m sglang.launch\_server \--model\-path meta\-llama/Meta\-Llama\-3\-8B\-Instruct \--tp 4 \--dist\-init\-addr sgl\-dev\-0:50000 \--nnodes 2 \--node\-rank 0

\# Node 1
python \-m sglang.launch\_server \--model\-path meta\-llama/Meta\-Llama\-3\-8B\-Instruct \--tp 4 \--dist\-init\-addr sgl\-dev\-0:50000 \--nnodes 2 \--node\-rank 1

Please consult the documentation below to learn more about the parameters you may provide when launching a server.

Model and tokenizer[#](https://docs.sglang.ai/backend/server_arguments.html#model-and-tokenizer "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------
...
*   `context_length`: The number of tokens our model can process _including the input_. Not that extending the default might lead to strange behavior.
...
Serving: HTTP & API[#](https://docs.sglang.ai/backend/server_arguments.html#serving-http-api "Link to this heading")
--------------------------------------------------------------------------------------------------------------------

### HTTP Server configuration[#](https://docs.sglang.ai/backend/server_arguments.html#http-server-configuration "Link to this heading")

*   `port` and `host`: Setup the host for HTTP server. By default `host: str = "127.0.0.1"` and `port: int = 30000`
    

### API configuration[#](https://docs.sglang.ai/backend/server_arguments.html#api-configuration "Link to this heading")
...
Parallelism[#](https://docs.sglang.ai/backend/server_arguments.html#parallelism "Link to this heading")
-------------------------------------------------------------------------------------------------------

### Tensor parallelism[#](https://docs.sglang.ai/backend/server_arguments.html#tensor-parallelism "Link to this heading")
...
### Data parallelism[#](https://docs.sglang.ai/backend/server_arguments.html#data-parallelism "Link to this heading")
...
### Expert parallelism[#](https://docs.sglang.ai/backend/server_arguments.html#expert-parallelism "Link to this heading")
...
Memory and scheduling[#](https://docs.sglang.ai/backend/server_arguments.html#memory-and-scheduling "Link to this heading")
---------------------------------------------------------------------------------------------------------------------------
...
Other runtime options[#](https://docs.sglang.ai/backend/server_arguments.html#other-runtime-options "Link to this heading")
---------------------------------------------------------------------------------------------------------------------------
...
Logging[#](https://docs.sglang.ai/backend/server_arguments.html#logging "Link to this heading")
-----------------------------------------------------------------------------------------------
...
Multi-node distributed serving[#](https://docs.sglang.ai/backend/server_arguments.html#multi-node-distributed-serving "Link to this heading")
---------------------------------------------------------------------------------------------------------------------------------------------
...
LoRA[#](https://docs.sglang.ai/backend/server_arguments.html#lora "Link to this heading")
-----------------------------------------------------------------------------------------
...
Kernel backend[#](https://docs.sglang.ai/backend/server_arguments.html#kernel-backend "Link to this heading")
-------------------------------------------------------------------------------------------------------------
...
Constrained Decoding[#](https://docs.sglang.ai/backend/server_arguments.html#constrained-decoding "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------
...
Speculative decoding[#](https://docs.sglang.ai/backend/server_arguments.html#speculative-decoding "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------
...
Double Sparsity[#](https://docs.sglang.ai/backend/server_arguments.html#double-sparsity "Link to this heading")
---------------------------------------------------------------------------------------------------------------
...
Debug options[#](https://docs.sglang.ai/backend/server_arguments.html#debug-options "Link to this heading")
-----------------------------------------------------------------------------------------------------------

_Note: We recommend to stay with the defaults and only use these options for debugging for best possible performance._
...
Optimization[#](https://docs.sglang.ai/backend/server_arguments.html#optimization "Link to this heading")
---------------------------------------------------------------------------------------------------------

_Note: Some of these options are still in experimental stage._
...
*   `torchao_config`: Experimental feature that optimizes the model with [torchao](https://github.com/pytorch/ao). Possible choices are: int8dq, int8wo, int4wo-<group\_size\>, fp8wo, fp8dq-per\_tensor, fp8dq-per\_row.
